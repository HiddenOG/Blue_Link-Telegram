...
async def group_welcome_new_members(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for member in update.message.new_chat_members:
        ...
        if member.id == context.bot.id:
            ...
            await update.message.reply_text(
                "👋 Hi everyone! I'm *BlueLink* — your group's business directory assistant.\n\n"
                "I can help you:\n"
        ...
        first_name = (member.first_name or "there").replace('_', ' ')
        await update.message.reply_text(
            f"👋 Welcome, *{first_name}*!\n\n"
            f"I'm *BlueLink* — the group's business directory bot.\n"
            f"Need a service provider? Just tell me what you're looking for!\n"
            f"Example: _\"I need a plumber in Lagos\"_\n\n"
...
async def group_find_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "1️⃣ **In this group**: Just ask naturally!\n"
        "Example: _\"I need a plumber in Lagos\"_\n\n"
        "2️⃣ **Private Menu**: [Message me privately](https://t.me/Blue_serviceBot?start=find) "
