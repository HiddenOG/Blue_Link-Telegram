...
async def find_service_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Also pull extra services from business_services relational table
    try:
        ...
        logging.warning(f"⚠️ Could not load extra services from business_services table: {svc_err}")
