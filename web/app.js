    ...
    if (!data.businesses || data.businesses.length === 0) {
        app.innerHTML = `
            <div style="text-align: center; padding: 60px 20px;">
                <div style="font-size: 80px; margin-bottom: 30px; filter: drop-shadow(4px 4px 0px #000);">🏪</div>
                <h2 style="color: var(--primary); margin-bottom: 15px; font-weight: 900; text-transform: uppercase;">No Business Yet</h2>
                <p style="color: var(--hint-color); margin-bottom: 40px; font-weight: 700;">
                    You need to register a business to access the dashboard analytics and features.
                </p>
                <button onclick="triggerRegistration()" class="premium-button">
